...
class SalaAsignatura(Base):
    ...
    id_matrix_sala = Column(String, index=True, nullable=False) # Ej: !xyz123:matrix.ugr.es

    alias_principal = Column(String, nullable=False)

    descripcion = Column(String)

    tipo = Column(Enum(TipoSala), nullable=False) # Espacio, sala o sala_avisos
