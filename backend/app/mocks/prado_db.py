...
PROFESOR = {
    ...
    "rol": "profesor",
    "matrix_id": "@e.samuelcantero:matrix.ugr.es", # Debería ser sin el e. pero es mi usuario para las pruebas
...
USUARIO1 = {
    ...
    "rol": "alumno",
    "matrix_id": "@e.ejemplo1:matrix.ugr.es",
...
USUARIO2 = {
    ...
    "rol": "alumno",
    "matrix_id": "@e.ejemplo2:matrix.ugr.es",
...
USUARIO3 = {
    ...
    "rol": "alumno",
    "matrix_id": "@e.ejemplo3:matrix.ugr.es",
